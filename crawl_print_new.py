...
# # =====================================================
# # IMAGE PARSER (⭐ lấy toàn bộ ảnh trang)
# # =====================================================
# def parse_all_images(soup):
#     imgs = set()
...
#         href = a["href"].lower()
#         if href.endswith(IMG_EXT):
#             imgs.add(urljoin(BASE_URL, href))

#     return sorted(imgs)


# # =====================================================
# # SPECS PARSER (⭐ FINAL UNIVERSAL)
# # =====================================================
...
#                 k = clean_text(td[0].get_text(" ", strip=True))
#                 v = clean_text(td[1].get_text(" ", strip=True))
...
#                     val = clean_text(cols[i+1].get_text(" ", strip=True))
#                     if val:
